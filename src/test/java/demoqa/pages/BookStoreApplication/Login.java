...
public class Login {
    ...
    public String firstNameInput = "Pokusaj";
    public String lastNameInput = "Neuspeo";
    public String userNameInput = "NeRadi";
    public String passwordInput = "Nista";
    ...
    public String validUserName = "Blablabla";
    public String validPassword = "MaliRadojivca1!";
