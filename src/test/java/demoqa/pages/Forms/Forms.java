...
public class Forms {
    ...
    public final String firstName = "Blagoje";
    public final String lastName = "Kumbura";
    public final String eMail = "blagojekumbura@gmail.com";
    public final String mobile = "0691234567";
    public final String subject = "Poetry";
    public final String address = "Atlanta bb";
