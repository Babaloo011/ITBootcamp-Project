...
public class TextBox {
    ...
    public final String sFullName = "Blablabla";
    public final String sEmail = "blagojekumbura@gmail.com";
    public final String sCurAddress = "San Francisko bb";
    public final String sPerAddress = "Atlanta bb";
